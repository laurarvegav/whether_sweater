...
VCR.configure do |config|
  ...
  config.filter_sensitive_data('<API_KEY>') { Rails.application.credentials.mapquest["key"] }
  config.filter_sensitive_data('<API_KEY>') { Rails.application.credentials.weather["key"] }
